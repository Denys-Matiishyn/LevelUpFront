...
export function Pricing() {
  const plans = [
    ...
    },
    {
      ...
      price: "2400",
      description: "Груповий тренінг: 8 занять по 2 години",
      features: [
        "Фізіологія стресу",
        "Техніки релаксації",
        "Емоційний інтелект",
    ...
    },
    {
      ...
      price: "1800",
      description: "Груповий тренінг: 6 занять по 2 години",
      features: [
        "Джерела самооцінки",
    ...
    },
    {
      ...
      price: "2100",
      description: "Груповий тренінг: 6 занять по 2.5 години",
      features: [
        "Активне слухання",
    ...
    {
      title: "Профорієнтація та кар'єрне самовизначення",
      price: "3000",
      description: "Індивідуальні заняття: 3 заняття по 1 годині",
      features: [
        "Аналіз нахилів та сильних сторін",
    ...
    },
    {
      ...
      price: "4400",
      description:
        "Груповий та індивідуальний тренінг для підлітків 13+: 4 тижні",
      features: [
